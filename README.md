...
= \Biggl\{
    \frac{1}{\sigma}\,
    \Biggl[
      f_a\,L_{\mathrm{surf}}^{\mathrm{dn}}
      + f_a\,L_{\mathrm{surf}}^{\mathrm{up}}
      + \frac{\alpha_{\mathrm{ir}}}{\varepsilon_p}\,
        \Bigl(
          f_a\,S_{\mathrm{surf}}^{\mathrm{dn,diffuse}}
          + f_a\,S_{\mathrm{surf}}^{\mathrm{up}}
          + f_p\,I^*
        \Bigr)
    \Biggr]
  \Biggr\}^{1/4}
